    ...
    "Disable all extensions" was set, change it to "none" to load all extensions again
            ...
            with gr.TabItem("Available", id="available"):
                with gr.Row():
                    ...
                    available_extensions_index = gr.Text(value="https://raw.githubusercontent.com/robonxt/sd-webui-extensions/master/index.json", label="Extension index URL").style(container=False)
